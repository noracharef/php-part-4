...
<html lang="fr" dir="ltr">
    ...
    <head>
        ...
        <title>Exerice php partie 4 exercice 3</title>
...
<nav>
    ...
    <h2>Exercice 3<h2>
    <p>Faire une fonction qui prend en paramètre deux chaines de caractères et qui revoit la concaténation de ces deux chaines.
</p>
...
function returnStrings($firstString, $secondString){
     ...
     echo returnStrings("Hello", "world");   
?>
